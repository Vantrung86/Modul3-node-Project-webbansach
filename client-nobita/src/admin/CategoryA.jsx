...
export default function CategoryA() {
    const [catergorys,serCatergory] = useState([]);
    ...
    //xoa
    const handleDeleteCatergory=async(id)=>{
    ...
    //Edit
   const handleEditCatergory = (item) =>{
        setCate(item);
        setCheck(true)
   }
   //Update
                            ...
                            <tr key={index}>
                                ...
                                <td>
                                    ...
                                    <button style={{padding:"3px 7px",backgroundColor:"red",borderRadius:"5px",border:"none"
                                        ,color:"white"}}
                                        onClick={()=>handleDeleteCatergory(item.id)}
                                    >
                                        Delete
                                    </button>
                                </td>
