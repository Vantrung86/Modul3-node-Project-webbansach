...
function ListSellerBook() {
  ...
  const getData = async ()=>{
    try {
      ...
      let res = response.data.filter((e)=>e.catergoryId === 2)
      setDatas(res)
    } catch (error) {   
      console.log(error);
    }
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="path">
          <p>
            Nobita.vn - Nhà Sách Trên Mạng /<span> Sách bán chạy</span>
          </p>
        </div>
